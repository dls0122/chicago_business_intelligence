...
func main() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=/cloudsql/silver-quest-348919:us-central1:mypostgres sslmode=disable port = 5432"
